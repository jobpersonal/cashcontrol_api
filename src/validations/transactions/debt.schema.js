...
const schema = joi.object({
  ...
  debt_value: joi.number().min(2000).message('El valor debe estart entre 2.000 y 5.000.000').max(5000000).message('El valor debe estart entre 2.000 y 5.000.000').required()
});
